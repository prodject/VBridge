...
func getVKCredsWithClientID(linkID string, vc vkCredentials, captchaSolver CaptchaSolver, solvedCaptchaSID, solvedCaptchaKey string, solvedCaptchaTs, solvedCaptchaAttempt float64, savedToken1 string) (*TURNCreds, error) {
	...
	// Smart Captcha v2 may provide redirect_uri + session_token without a
	// captcha_sid. Do not send an empty captcha_sid in that case.
	...
	// Gate on the success token: Smart Captcha v2 no longer guarantees a SID.
	if solvedCaptchaKey != "" {
